...
class Game extends Phaser.Scene {
  ...
  preload() {
    for(let i of Object.keys(_skins_json__WEBPACK_IMPORTED_MODULE_8__)){
      this.load.image(`skin_${_skins_json__WEBPACK_IMPORTED_MODULE_8__[i].url}`, `/img/skins/${_skins_json__WEBPACK_IMPORTED_MODULE_8__[i].url}.png`);
    }
...
/* harmony import */ var _game_disconnect_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
