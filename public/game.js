...
class disconnect_scene extends Phaser.Scene {
  ...
  create(){
    this.disconnecttext = new _objects_text_js__WEBPACK_IMPORTED_MODULE_0__["default"](this, window.innerWidth / 2, 100, window.error, { fontSize: 50, fontFamily: "Arial" }).setOrigin(0.5);
